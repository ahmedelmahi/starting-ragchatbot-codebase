...
class TestAIGeneratorDirectResponse:
    ...
    def test_generate_response_returns_text_for_simple_query(self, mock_anthropic_class):
...
class TestAIGeneratorNoToolManager:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_returns_empty_response_when_tool_use_without_manager(self, mock_anthropic_class):
...
class TestAIGeneratorSequentialToolCalls:
    ...
    def test_two_sequential_tool_calls_succeed(self, mock_anthropic_class):
        ...
        mock_client.messages.create.side_effect = [
            mock_response_1, mock_response_2, mock_final
        ]
    ...
    def test_max_rounds_forces_final_response(self, mock_anthropic_class):
        ...
        mock_client.messages.create.side_effect = [
            mock_tool_response, mock_tool_response, mock_final
        ]
